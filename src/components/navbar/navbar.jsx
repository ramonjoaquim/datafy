    ...
    return (
        <div className='nav' id="nav">
            ...
            <div className='nav-menu'>
                ...
                <Link className='nav-link' activeClassName="active" to='/privacy'>
                    <h4>Privacy</h4>
                </Link>
            ...
            <div className='nav2'>
                <div className='nav-btn'>
                    <img src={getUserContext().userProfileImage} alt="profile image" className='profile-img'
                         onClick={() => openProfileContent()}/>
                    <span className='font-dazzle profile-name'
                          onClick={() => openProfileContent()}>{getUserContext().userDisplayName}</span>
                    <MdArrowDropDown size={25} onClick={() => openProfileContent()}></MdArrowDropDown>
                    <div className='profile-content' id="profileContent">
                        <ul>
                            <MdArrowDropUp className='icon-arrow-up' size={40}
                                           onClick={() => openProfileContent()}></MdArrowDropUp>
                            <li>
            ...
            {/* mobile */}
            <img src={getUserContext().userProfileImage}
                alt="profile image"
                className='profile-img-mobile bars'
                onClick={handleMenu}/>
            ...
            <div className='nav-menu-mobile' id="nav-menu-mobile">
                <div className='menu-mobile'>
                    ...
                    <Link className='menu-item' activeClassName="active" to='/privacy'>
                        Privacy
                    </Link>
                    <Link className='menu-item' activeClassName="active" to='/about'>
                        About
                    </Link>
